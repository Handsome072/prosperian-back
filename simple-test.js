...
async function testAPI() {
  ...
  try {
    ...
    const filterTypes = await axios.get('http://69.62.105.91:4000/api/linkedin-sales/filter-types');
    ...
    const simpleUrl = await axios.post('http://69.62.105.91:4000/api/linkedin-sales/generate-url', {
      searchType: 'people',
    ...
    const complexUrl = await axios.post('http://69.62.105.91:4000/api/linkedin-sales/generate-url', {
      searchType: 'people',
      keywords: 'développeur',
      filters: [
        {
    ...
    const validation = await axios.post('http://69.62.105.91:4000/api/linkedin-sales/validate-filters', {
      searchType: 'people',
      filters: [
        {
          type: 'CURRENT_COMPANY',
    ...
    const parsing = await axios.post('http://69.62.105.91:4000/api/linkedin-sales/parse-url', {
